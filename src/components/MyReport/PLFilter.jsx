...
const PLFilter = ({
  setPLData, // Parent state for storing fetched P&L data
  setTotalTransactions, // Parent state for total transactions
  setTotalPages, // Parent state for total pages
  setIsDataFetched, // Parent state for marking if data has been fetched
  entriesToShow, // Number of entries to show
