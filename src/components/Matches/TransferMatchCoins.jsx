...
const handleOddsWinnerDeclare = async () => {
  ...
  console.log('marketData?.[0]?.oddsResult', marketData?.[0]?.oddsResult)
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {/* Button */}
        <div className="mx-4">
          <button disabled={marketData?.[0]?.oddsResult === 1} onClick={handleOddsWinnerDeclare} className="px-6 py-2 bg-lightblue text-white font-semibold rounded hover:bg-blue-600 disabled:bg-gray-300">
      ...
      <div className="text-center mb-4">
        ...
        {/* Transfer Coins */}
        <div className="flex-1 text-right invisible">
          <button className="px-6 py-2 bg-lightblue text-white font-semibold rounded hover:bg-green-600">
            Transfer Coins
          </button>
        </div>
