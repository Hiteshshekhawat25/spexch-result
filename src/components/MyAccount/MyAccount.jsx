  ...
  return (
    <div className="flex justify-center mt-6">
      {loading ? (
        ...
        <>
          <div
            className={`w-full sm:w-1/4 border border-gray-400 mx-4 sm:mx-8 bg-white ${containerHeight} overflow-hidden`}
          >
            ...
            <div className="w-full border-collapse">
              ...
              {selectedUser ? (
                <>
                 <div                
                className={`cursor-pointer text-left border-b border-gray-300 hover:bg-lime ${
                  selectedPage === 'bethistory' ? 'font-bold bg-bluehover' : ''
                }`}
              ...
              <div
                                className={`cursor-pointer text-left border-b border-gray-300 hover:bg-lime ${
                  selectedPage === 'profitLoss' ? 'font-bold bg-bluehover' : ''
                }`}
