...
//   // Update ScoreId function (also calls the API to update the match)
//   const handleUpdateScoreId = async () => {
//     if (newScoreId !== scoreId) { // Only call API if the scoreId is different
//       try {
//         const payload = { scoreId: newScoreId };
//         const response = await putUpdateMatchAPIAuth(`match/updatematch/${match._id}`, payload);
//         if (response.status === 200) {
//           console.log("Score ID updated successfully");
//           // Optionally, you could dispatch the updated scoreId to the store
//           dispatch(updateScore({ name: "scoreId", value: newScoreId }));
//           onCancel(); 
//         } else {
//           console.error("Failed to update Score ID");
//         }
//       } catch (error) {
...
//   // Update Teams function (also calls the API to update the match)
//   const handleUpdateTeams = async () => {
//     if (newTeam1Name !== team1 || newTeam2Name !== team2) { // Only update if the team names have changed
//       try {
//         const payload = { team1: newTeam1Name, team2: newTeam2Name };
//         const response = await putUpdateMatchAPIAuth(`match/updatematch/${match._id}`, payload);
//         if (response.status === 200) {
//           console.log("Teams updated successfully");
//           // Optionally, dispatch the updated team names to the store
//           dispatch(updateScore({ name: "team1", value: newTeam1Name }));
//           dispatch(updateScore({ name: "team2", value: newTeam2Name }));
//           onCancel(); 
//         } else {
//           console.error("Failed to update teams");
//         }
//       } catch (error) {
...
//                 onChange={(e) => setNewScoreId(e.target.value)} // Update local state
//                 className="w-full p-2 mt-1 border border-gray-300 rounded-lg"
//               />
...
//                   onChange={(e) => setNewTeam1Name(e.target.value)} // Update local state
//                   className="w-full p-2 mt-1 border border-gray-300 rounded-lg"
//                 />
//               </div>
...
//                   onChange={(e) => setNewTeam2Name(e.target.value)} // Update local state
//                   className="w-full p-2 mt-1 border border-gray-300 rounded-lg"
//                 />
//               </div>
//             </div>
...
//                 type="text"
//                 value={scoreId}
//                 onChange={(e) => dispatch(updateScore({ name: "scoreId", value: e.target.value }))}
//                 className="w-full p-2 mt-1 border border-gray-300 rounded-lg"
//               />
//               <div className="flex justify-end mt-2"> {/* Align button to the right */}
//                 <button
...
//                   type="text"
//                   value={team1}
//                   onChange={(e) => dispatch(updateScore({ name: "team1", value: e.target.value }))}
//                   className="w-full p-2 mt-1 border border-gray-300 rounded-lg"
//                 />
//               </div>
...
//                   type="text"
//                   value={team2}
//                   onChange={(e) => dispatch(updateScore({ name: "team2", value: e.target.value }))}
//                   className="w-full p-2 mt-1 border border-gray-300 rounded-lg"
//                 />
//               </div>
//             </div>
